...
movie_data_path = api.read('dataset/movies.csv', remote='data')
finantial_data_path = api.read('dataset/finantials.csv', remote='data')
opening_data_path = api.read('dataset/opening_gross.csv', remote='data')
